...
def test_data_attribute_dynamic():
    ...
    assert div.attributes[0].is_dynamic_name == True
    print(f"✓ data-* attribute with dynamic part works")
...
def test_htmx_dynamic():
    ...
    assert div.attributes[0].is_dynamic_name == True
    print(f"✓ HTMX attribute with dynamic part works")
...
def test_alpine_dynamic():
    ...
    assert div.attributes[0].is_dynamic_name == True
    print(f"✓ Alpine.js attribute with dynamic part works")
...
def test_dynamic_with_template_tag():
    ...
    template = '<div data-{% if active %}on{% else %}off{% endif %}="true">Content</div>'
    ...
    assert div.attributes[0].is_dynamic_name == True
    print(f"✓ Dynamic with template tag works")
